...
\begin{frame}{Giro o eliminación del término cruzado}
  ...
  Cónica en la referencia inicial: "Eliminar el término cruzado"

  \begin{equation*}
    (xy)^T A (x) + 2(a_{13} a_{23})^T (x) + a_{33} = 0
  \end{equation*}

  Autovectores de $T$ ortonormales, Autovalores de $T$

  \begin{equation*}
    T \text{ es simétrica } \exists P \text{ con } P^{-1} = P^t | P^t T P = P^{-1} T P = D = \begin{bmatrix} \lambda_1 & 0 \\ 0 & \lambda_2 \end{bmatrix} \text{ diagonal}
  \end{equation*}

  Cambio de referencia: $(x', y') = P(x)$ Conserva distancias. Importante para NO deformar la cónica

  \begin{equation*}
    (x' y') P^t T P (x) + 2(a_{13} a_{23}) P(x) + a_{33} = 0
  \end{equation*}

  \begin{equation*}
    (x' y') D (x) + 2(a_{13} a_{23}) P(x) + a_{33} = 0
  \end{equation*}
...
\begin{frame}{Traslación o eliminación de la parte lineal}
  \frametitle{Traslación o eliminación de la parte lineal}

  Cambio de referencia: Conserva distancias
  ...
  \begin{equation*}
    \lambda_1(x' + \frac{b_{13}}{2\lambda_1})^2 + \lambda_2(y' + \frac{b_{23}}{2\lambda_2})^2 + a_{33} = 0
  \end{equation*}

  \begin{equation*}
    \lambda_1x''^2 + \lambda_2y''^2 + d = 0 \quad \text{(traslación)}
  \end{equation*}

  Cambio de referencia:

  \begin{equation*}
    (x'', y'') = \left(x' - \frac{b_{13}}{\lambda_1}, y' - \frac{b_{23}}{\lambda_2}\right)
  \end{equation*}
